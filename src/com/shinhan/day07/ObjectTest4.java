...
//		Math.max(0, 0)
	...
	private static void f10() {
		String s = "이것이 자바다 1234 This is 66 Java 55";
	...
	private static void f7() {
		...
		System.out.println(a+b.intValue()+200); // unBoxing: b.intValue()
		float f = b.floatValue();
		
		System.out.println(Integer.MAX_VALUE);
		
		int su = Integer.compare(10, 15);
	...
	private static void f5() {
		String number = "010-3124-8708 010-1234-8786";
	...
	private static void f1() throws UnsupportedEncodingException {
		...
		byte[] arr1 = new byte[] {49,20,51,52,53};
