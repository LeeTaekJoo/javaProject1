...
public class CollectionTest2 {
	...
	private static void f14() {
		...
		//data2.add(new Fruit("사과",200));	 // 수정 불가
		for(Fruit f:data2) {
	...
	private static void f12() {
		// 수정불가한 Collection	
		Set<Integer> listData = Set.of(100,90,88,99,55); // 값은 중복불가
//		listData.add(11);
		// listData.add(9999); // 수정이 불가하다
	...
	private static void f11() {
		// 수정불가한 Collection
		int[] arr = new int[] {100,90,88,99,55};
		List<Integer> listData = List.of(100,90,88,99,55);
	...
	private static void f6() {
		...
		data.add(new Board(2, "자율회식","저녁개방", "jin"));
	...
	private static void f3() {
		...
		data.add(new Employee("직원1", "사원", 1000));
		data.add(new Employee("직원5", "대리", 6000));
		data.add(new Employee("직원6", "과장", 7000));
		data.add(new Employee("직원3", "사장", 8000));
	...
	private static void f2() {
		...
		data.add(new Account("125", "홍3", 2000));
		data.add(new Account("126", "홍2", 3000));
