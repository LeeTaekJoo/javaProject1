...
public class LambdaTest3 {
	...
	private static void f8() {
		BiFunction<String, String, Account> func2 = (no,ower)-> {
			System.out.println("계좌번호: " + no);
			System.out.println("ower: " + ower);
			return new Account(no, ower);
		};
		Account acc = func2.apply("1234", "lee");
	...
	private static void f5() {
		...
		result = func2.test(new Account("1234", "Lee", 1000));
		System.out.println(result);
	...
	private static void f3() {
		...
		Account acc2 = func2.apply("5555","이택주");
	...
	private static void f1() {
		...
		f3.accept("자바시험", 100);
		f4.accept(new Account("1234", "이택주", 1000));
	}
